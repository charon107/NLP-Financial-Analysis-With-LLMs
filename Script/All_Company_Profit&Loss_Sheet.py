...
def construct_balance_sheet_url(base_url):
    ...
    # 构建balance sheet的URL
    balance_sheet_url = f"https://www.moneycontrol.com/financials/{company_name}/profit-lossVI/{code}#{code}"
...
def write_csv_for_year(year, data, csv_header):
    csv_file_path = f'D:\Program Files (x86)\Python\PythonProject\FYP\Financial Report\Test\Company_Profit&Loss_Sheet_{year}.csv'
    # 检查文件是否存在，以决定是否写入表头
